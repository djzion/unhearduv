...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venue.featured_image'
        db.add_column('musicblog_venue', 'featured_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.featured_image'
        db.add_column('musicblog_event', 'featured_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venue.featured_image'
        db.delete_column('musicblog_venue', 'featured_image')

        # Deleting field 'Event.featured_image'
        db.delete_column('musicblog_event', 'featured_image')
