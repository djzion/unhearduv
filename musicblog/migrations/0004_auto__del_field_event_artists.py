...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.artists'
        db.delete_column('musicblog_event', 'artists_id')

        # Adding M2M table for field artists on 'Event'
        db.create_table('musicblog_event_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['musicblog.event'], null=False)),
            ('artist', models.ForeignKey(orm['musicblog.artist'], null=False))
        ))
        db.create_unique('musicblog_event_artists', ['event_id', 'artist_id'])


    def backwards(self, orm):
        # Adding field 'Event.artists'
        db.add_column('musicblog_event', 'artists',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['musicblog.Artist']),
                      keep_default=False)

        # Removing M2M table for field artists on 'Event'
        db.delete_table('musicblog_event_artists')
