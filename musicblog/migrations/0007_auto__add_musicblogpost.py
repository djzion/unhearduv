...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MusicBlogPost'
        db.create_table('musicblog_musicblogpost', (
        ...
        db.send_create_signal('musicblog', ['MusicBlogPost'])


    def backwards(self, orm):
        # Deleting model 'MusicBlogPost'
        db.delete_table('musicblog_musicblogpost')
    ...
    models = {
        ...
        'musicblog.musicblogpost': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'MusicBlogPost', '_ormbases': ['blog.BlogPost']},
